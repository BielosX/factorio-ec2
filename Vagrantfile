Vagrant.configure("2") do |config|
    ...
    config.vm.provision "shell", path: "make_saves_dir.sh"
    config.vm.provision "shell", path: "vagrant_copy_to_priv.sh"
    config.vm.provision "shell", path: "factorio_install.sh"
